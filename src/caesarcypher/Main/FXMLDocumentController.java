...
import caesarcypher.CaesarCypher;
import caesarcypher.Tool.CifradoCesar;
...
public class FXMLDocumentController implements Initializable {
    ...
    private void btnDescifrarOnAction(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(CaesarCypher.class.getResource("Descifrar/DescifrarFXML.fxml"));
